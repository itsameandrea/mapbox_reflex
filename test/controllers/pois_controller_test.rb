...
class PoisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create poi" do
    assert_difference('Poi.count') do
      post pois_url, params: { poi: { address: @poi.address, latitude: @poi.latitude, longitude: @poi.longitude, name: @poi.name } }
    end
  ...
  test "should update poi" do
    patch poi_url(@poi), params: { poi: { address: @poi.address, latitude: @poi.latitude, longitude: @poi.longitude, name: @poi.name } }
